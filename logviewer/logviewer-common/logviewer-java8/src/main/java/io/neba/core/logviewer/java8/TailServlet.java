 ...
 * @author Olaf Otto
 */
@Component(service = io.neba.core.logviewer.TailServlet.class)
public class TailServlet extends WebSocketServlet implements io.neba.core.logviewer.TailServlet {
